...
<body style="background-color: #90EE90">
	...
	<h2 align="center" style="color: #CD5C5C">Add Feed Shipment
		Arrival</h2>
	<h1 style="color: red">${exception}</h1>

	<form:form method="post" modelAttribute="addfeedship"
		action="addfeedship">
		...
		<table style="position: absolute; left: 350px; top: 200px">
			...
			<tr>
				<td><label for="feedquantity">Feed Quantity Arrived : </label>
				</td>
